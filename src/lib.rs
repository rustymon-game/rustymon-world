...
pub fn parse<Feature, Visual>(config: Config<Visual>) -> Result<Vec<formats::Tile<Feature>>, String>
where
    Visual: FeatureParser<AreaFeature = Feature, NodeFeature = Feature, WayFeature = Feature>,
{
    let Config {
        file,
        cols,
